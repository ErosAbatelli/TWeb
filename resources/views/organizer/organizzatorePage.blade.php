...
<body>
    ...
    @if(session('categoria')!=3)
    <hr><hr><hr><hr><hr><hr>
    PAGINA NON DISPONIBILE
    <hr><hr><hr><hr><hr><hr>
    @else

    <form id="update" method="POST" action="{{ route('ModificaProfilo') }}">

        <div class="container">
            <div class="main">
                <div class="topbar">
                    @if(isset($_GET["action"]))
                    <a href="organizzatorePage">Annulla Modifiche</a>
                    <a></a>
                    @else
                    <a href="organizzatorePage?action">Modifica Profilo</a>
                    <a href="{{route('eventiOrganizzatore')}}">Visualizza i miei eventi</a>
                    <a href="{{ route('creaEvento')}}" title='creaEvento'>Crea Evento</a>
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mt-1">
                        <div class="card mb-3 content">
                            ...
                            <h1 class="m-3 pt-3">Informazioni Organizzatore</h1>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 text-secondary">
                                        ...
                                        <input type="text" class="input-field" value="{{session('nome')}}" name="nome">
                                        @else
                                        {{session('nome')}}
                                        @endif
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 text-secondary">
                                        @if(isset($_GET["action"]))
                                        <input type="text" class="input-field" value="{{session('cognome')}}" name="cognome">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 text-secondary">
                                        @if(isset($_GET["action"]))
                                        <input type="number" class="input-field" value="{{session('telefono')}}" name="telefono">
